...
<p align="center">
  <strong>EN</strong> Safe patterns for environment example files (no real secrets).<br/>
  <strong>PT</strong> Padrões seguros para ficheiros de exemplo de ambiente (sem segredos reais).
</p>
...
| English | Português |
|---------|-----------|
| Safe patterns for environment example files (no real secrets). | Padrões seguros para ficheiros de exemplo de ambiente (sem segredos reais). |
...
- `examples/.env.example` — sample / exemplo
- `guidelines.md` — do/don't / boas práticas
